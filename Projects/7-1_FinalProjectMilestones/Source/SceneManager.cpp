...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture("../../Utilities/textures/counter.jpg", "counter");
	bReturn = CreateGLTexture("../../Utilities/textures/Egg.jpg", "egg");
	bReturn = CreateGLTexture("../../Utilities/textures/Plate.jpg", "plate");
	bReturn = CreateGLTexture("../../Utilities/textures/Glass.jpg", "hot_sauce");
	bReturn = CreateGLTexture("../../Utilities/textures/BottleCap.jpg", "Cap");
	bReturn = CreateGLTexture("../../Utilities/textures/SauceLiquid2.jpg", "liquid");
	bReturn = CreateGLTexture("../../Utilities/textures/Cereal2.jpg", "cereal");
...
void SceneManager::DefineObjectMaterials()
{
	...
	OBJECT_MATERIAL shellMaterial;
	shellMaterial.ambientColor = glm::vec3(0.1f, 0.1f, 0.1f);
	shellMaterial.ambientStrength = 0.2f;
	shellMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.3f);
	shellMaterial.specularColor = glm::vec3(0.1f, 0.1f, 0.1f);
	shellMaterial.shininess = 0.2;
	shellMaterial.tag = "shell";

	m_objectMaterials.push_back(shellMaterial);
}
...
void SceneManager::PrepareScene()
{
	...
	// Set up lights (e.g., point light)
	glm::vec3 lightPosition = glm::vec3(5.0f, 10.0f, 5.0f);
	glm::vec3 lightColor = glm::vec3(1.0f, 1.0f, 1.0f);
	m_pShaderManager->setVec3Value("light.position", lightPosition);
	m_pShaderManager->setVec3Value("light.color", lightColor);

	// Set up a secondary light source if needed
	glm::vec3 secondaryLightPosition = glm::vec3(-10.0f, -10.0f, -10.0f);
	glm::vec3 secondaryLightColor = glm::vec3(0.5f, 0.5f, 0.5f);
	m_pShaderManager->setVec3Value("secondaryLight.position", secondaryLightPosition);
	m_pShaderManager->setVec3Value("secondaryLight.color", secondaryLightColor);
}
...
void SceneManager::RenderScene()
{
	...
	glm::vec3 lightColor = glm::vec3(1.0f, 0.8f, 0.5f);

	// Pass the light properties to the shader
	m_pShaderManager->setVec3Value("lightPosition", lightPosition);
	...
	SetShaderTexture("hot_sauce");
	SetShaderMaterial("glass");

	// draw the mesh with transformation values
	m_basicMeshes->DrawSphereMesh();

	/************* HOT SAUCE BOTTLE NECK ****************/
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 7.0f, 0.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.8f, 0.6f, 0.4f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(5.0f, 0.1f, 5.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 0.3f, 5.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 0.15f, 5.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(5.0f, 6.0f, 1.0f);
